...
public class TaskDeletionPanel extends AbstractTaskChangerGridBagJPanel implements SelectStatements, DeleteStatements {
	...
	protected void updateTable() {
		...
		for (TaskRow tr : TaskChooserPanel.getTasksList()) {
			if (tr.getName().equalsIgnoreCase(taskName)) {
				...
				Object[][] objectSubTasks = new Object[tr.getSubTasks().size()][3];
	...
	protected void deleteTask() {
		...
		int answer = JOptionPane.showOptionDialog(null,
				"Are you sure you want to delete " + (String) tasksComboBox.getSelectedItem() + "?", "Confirm Delete",
